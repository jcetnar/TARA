      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <h3 class="text-center">Jessica Cetnar</h3>
            <p class="text-center">Electrical Engineer</p>
          </div>
          <div class="col-md-4">
            <img src="http://pingendo.github.io/pingendo-bootstrap/assets/user_placeholder.png"
            class="center-block img-circle img-responsive">
            <h3 class="text-center">Grace McFassel</h3>
            <p class="text-center">Computer Engineer</p>
          </div>
          <div class="col-md-4">
            <img src="http://pingendo.github.io/pingendo-bootstrap/assets/user_placeholder.png"
            class="center-block img-circle img-responsive">
            <h3 class="text-center">Carly Traum</h3>
            <p class="text-center">Electrical Engineer</p>
          </div>
        </div>
      </div>
