<html>
  <head>
    <link rel="stylesheet" type="text/css" href="app/css/canvas.css">
    <script type='text/javascript' src='https://code.jquery.com/jquery-3.1.1.min.js'></script>
    <script type='text/javascript' src='app/js/canvas.js'></script>
  </head>
  <body>
    ...
    <ul class='objects-menu'>
     ...
     <li data-id="<?php echo $object['rfid']; ?>"> <?php echo $object['name']; ?></li>
     <?php endforeach; ?> 
    </ul>
